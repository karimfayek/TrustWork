        ...
        <AuthenticatedLayout>
            <div className="my-6 mx-auto bg-white shadow rounded p-6">
                ...
                <form onSubmit={handleSave} className="space-y-4">
                    ...
                    <div>
                        <label className="block mb-1 font-medium">
                            ضع إيميلات الإشعارعند طلب سلفة
                        </label>
                        <input
                            type="text"
                            name="loan_notify"
                    ...
                    <div>
                        <label className="block mb-1 font-medium">
                            ضع إيميلات الإشعار لتسعير مشروع جديد{" "}
                        </label>
                        <input
                            type="text"
                            name="pricing_notify"
                    ...
                    <div>
                        <label className="block mb-1 font-medium">
                            ضع إيميلات الإشعار عند تسجيل حضور موظف
                        </label>
                        <input
                            type="text"
                            name="att_notify"
                    ...
                    <div>
                        <label className="block mb-1 font-medium">
                            ضع إيميلات الإشعار للتقدم فى بنود المشروع
                        </label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label className="block mb-1 font-medium">
                            ضع إيميلات الإشعار عند الموافقة على عرض السعر
                        </label>
                        <input
                            type="text"
                            name="quote_notify"
                            value={settings.quote_notify}
                            onChange={handleChange}
                            placeholder="مثال: v1@test.com, v2@test.com"
                            className="w-full border rounded p-2 focus:outline-none focus:ring focus:ring-blue-200"
                        />
                    ...
                    <div>
                        <label className="block mb-1 font-medium">
                            ضع إيميلات الإشعار عند إنشاء أمر شغل
                        </label>
                        <input
                            type="text"
                            name="work_order_notify"
                            value={settings.work_order_notify}
                            onChange={handleChange}
                            placeholder="مثال: v1@test.com, v2@test.com"
                            className="w-full border rounded p-2 focus:outline-none focus:ring focus:ring-blue-200"
                        />
