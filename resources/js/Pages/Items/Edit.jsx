...
export default function Edit({ item }) {
  ...
  return (
    ...
    <div className="p-6 max-w-2xl mx-auto">
      <h1 className="text-2xl font-bold mb-4">تعديل الصنف: {item.name}</h1>
...
<div>
        ...
        <div>
          <label className="block mb-1">حد التنبيه</label>
          <input
            type="number"
            step="0.01"
            className="w-full border rounded px-3 py-2"
        ...
        <div className="flex justify-between">
          ...
          <button type="submit" className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">تحديث</button>
        </div>
      </form>
    </div>
