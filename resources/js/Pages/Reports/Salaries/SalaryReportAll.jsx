...
function SalaryRow({ user, filters, setLoading, onCalculated }) {
  ...
  return (
    <tr className="border-b">
      <td className="p-2"><Link className="hover:text-blue-500" href={route('admin.user.edit' , user.id)}>{user.name}</Link> </td>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="flex flex-col justify-end">
          <button
            ...
            className={`py-2 px-4 rounded-lg transition text-white ${loading
